...
y_data=[]
ttg='VB'
for i in confusion[ttg]:
    if confusion[ttg][i]>100:
        xticks.append(urllib.quote_plus(i))
        y_data.append(confusion[ttg][i])

print(len(xticks))
print(len(y_data))

x_cord=range(1,len(y_data)+1)
print(len(x_cord))
pyplot.xticks(x_cord,xticks)
pyplot.bar(x_cord,y_data)
pyplot.show()